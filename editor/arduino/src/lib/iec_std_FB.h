...
static void DERIVATIVE_body__(DERIVATIVE *data__)
{
  ...
  {
    __SET_VAR(data__->, XOUT, , ((((3.0 * (__GET_VAR(data__->XIN, ) - __GET_VAR(data__->X3, ))) + __GET_VAR(data__->X1, )) - __GET_VAR(data__->X2, )) / (10.0 * TIME_TO_REAL((BOOL)__BOOL_LITERAL(TRUE), NULL, (TIME)__GET_VAR(data__->CYCLE, )))));
...
static void INTEGRAL_body__(INTEGRAL *data__)
{
  ...
  {
    __SET_VAR(data__->, XOUT, , (__GET_VAR(data__->XOUT, ) + (__GET_VAR(data__->XIN, ) * TIME_TO_REAL((BOOL)__BOOL_LITERAL(TRUE), NULL, (TIME)__GET_VAR(data__->CYCLE, )))));
  };
...
static void RAMP_body__(RAMP *data__)
{
  ...
  if (__GET_VAR(data__->RUN, ))
  {
    ...
    {
      __SET_VAR(data__->, XOUT, , (__GET_VAR(data__->XI, ) + (((__GET_VAR(data__->X1, ) - __GET_VAR(data__->XI, )) * TIME_TO_REAL((BOOL)__BOOL_LITERAL(TRUE), NULL, (TIME)__GET_VAR(data__->T, ))) / TIME_TO_REAL((BOOL)__BOOL_LITERAL(TRUE), NULL, (TIME)__GET_VAR(data__->TR, )))));
